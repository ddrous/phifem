...
\thesistitle{Simulation of soft tissues using innovative non-conforming Finite Elements Methods} % Your thesis title, ths is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{\href{http://mduprez.perso.math.cnrs.fr/}{Michel \textsc{Duprez}} \\ \href{http://stephanecotin.com/}{Stephane \textsc{Cotin}} } % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\university{\href{http://www.unistra.fr}{University of Strasbourg}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\group{\href{https://mimesis.inria.fr/}{team MIMESIS}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\begin{figure}[!htb]
   ...
   \begin{minipage}{0.32\textwidth}
    \centering
    \includegraphics[width=.8\linewidth]{LogoMimesis}
    \label{Fig:LogoMimesis}
  \end{minipage}\hfill
   \begin{minipage}{0.32\textwidth}
     \centering
     \includegraphics[width=.8\linewidth]{LogoINRIA.png}
     \label{Fig:LogoInria}
   \end{minipage}
\end{figure}
...
\textsc{\Large Project report V1}\\[0.5cm] % Thesis type
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=.9\linewidth]{IntroPic.png}
    \label{Fig:IntroPic}
\end{figure}


\large \textit{This project was completed for the \href{https://docs.google.com/document/d/10JbbXeqqu5J2BjMkSQRNQ8Gx7xBPOClLKpvd7EBZT8U/edit}{master 2 CSMI}}\\[0.2cm] % University requirement text
\textit{from October 14, 2020 to January 27, 2021}\\[0.2cm]
\textit{initiated by \groupname}\\[0.2cm] % Research group
\textit{at \href{https://www.inria.fr/en}{Inria}.}\\[2cm] % Department name
...
\qquad I would like to thank Mr. \textsc{Duprez} for his uncountable advice, and all the time he spent helping get my code working. It would have been significantly harder (likely impossible) were it not for his indispensable help and assistance.  
